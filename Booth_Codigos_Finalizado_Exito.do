...
margins, atmeans at(prosocial_index_core=(-20(5)50)) post
...
eststo clear
probit outcome2_scenario c.prosocial_index_core c.dist1 c.age_clean i.sex_num , vce (robust)
margins, atmeans at(age_clean=(18(5)70)) post
...
probit outcome1_scenario c.prosocial_index_core c.dist1 c.age_clean i.sex_num , vce (robust)
margins, atmeans at(prosocial_index_core=(-20(5)50))
marginsplot, ///
...
probit outcome2_scenario c.prosocial_index_core c.dist1 c.age_clean i.sex_num,  vce (robust)
margins, atmeans at(age_clean=(18(5)70))
marginsplot, ///
    recast(line) recastci(rarea) ///
